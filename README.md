...
- **Mouseover & Mouseout** → terjadi saat mouse masuk atau keluar dari area  
- **Focus & Blur** → terjadi saat elemen aktif atau tidak aktif  
...
3. Lakukan interaksi pada setiap elemen yang tersedia  
4. Amati perubahan pada area output  
